...
/// </code>
/// </example>
public class CommonWebServicesOptions
{
    /// <summary>
    ...
    /// 
    /// Note: Even if both are configured to be used, the middleware must be configured to use either, so this "skips" the need of the consumer to add the services
    /// </summary>
    ...
    /// </summary>
    public Assembly[] EndpointAssemblies { get; set; } = null;
