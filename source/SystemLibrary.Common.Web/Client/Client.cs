...
public partial class Client
{
    ...
    /// </code>
    /// </example>
    public ClientResponse<T> Get<T>(string url, object payload, MediaType mediaType = MediaType.xwwwformUrlEncoded, int timeoutMilliseconds = DefaultTimeout, IDictionary<string, string> headers = null, JsonSerializerOptions jsonSerializerOptions = default, CancellationToken cancellationToken = default, Func<string, T> deserialize = null)
    {
        return GetAsync<T>(url, payload, mediaType, timeoutMilliseconds, headers, jsonSerializerOptions, cancellationToken, deserialize)
    ...
    /// </code>
    /// </example>
    public async Task<ClientResponse<T>> GetAsync<T>(string url, object payload, MediaType mediaType = MediaType.xwwwformUrlEncoded, int timeoutMilliseconds = DefaultTimeout, IDictionary<string, string> headers = null, JsonSerializerOptions jsonSerializerOptions = default, CancellationToken cancellationToken = default, Func<string, T> deserialize = null)
    {
