...
partial class Client
{
    ...
    {
        return $"{options.Method} {options.Url} as {options.MediaType.ToValue()} with timeout: {options.Timeout}ms, using retryPolicy: {options.UseRetryPolicy.ToString().ToLower()} ";
    }
